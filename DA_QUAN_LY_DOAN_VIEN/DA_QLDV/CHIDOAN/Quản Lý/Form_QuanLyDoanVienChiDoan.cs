...
namespace DA_QLDV
{
    public partial class Form_QuanLyDoanVienChiDoan : Form
    {
        public Form_QuanLyDoanVienChiDoan()
        {
            InitializeComponent();
        }
        ...
        private void Form_QuanLyDoanVienChiDoan_Load(object sender, EventArgs e)
        {
            My_Database db = new My_Database();
            SqlDataAdapter adapter1 = new SqlDataAdapter();
            DataTable table1 = new DataTable();
            txtChidoan.Text = Global.GlobalLop;
            fillGrid(new SqlCommand("SELECT * FROM Sinhvien Where CDoan = '" + Global.GlobalLop + "'"));
        }
