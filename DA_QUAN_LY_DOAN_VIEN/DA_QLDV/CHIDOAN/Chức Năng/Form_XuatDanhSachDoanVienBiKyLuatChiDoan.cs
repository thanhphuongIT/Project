...
namespace DA_QLDV
{
    public partial class Form_XuatDanhSachDoanVienBiKyLuatChiDoan : Form
    {
        public Form_XuatDanhSachDoanVienBiKyLuatChiDoan()
        {
            InitializeComponent();
        }
        ...
        private void Form_XuatDanhSachDoanVienBiKyLuatChiDoan_Load(object sender, EventArgs e)
        {
            fillGrid(new SqlCommand("select KyLuat.MaKL,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,KyLuat.Loaivipham,KyLuat.Hinhthuc,KyLuat.Namhoc,sinhvien.Picture"
                + " from Sinhvien INNER JOIN KyLuat ON KyLuat.MaDV = Sinhvien.MSSV And sinhvien.CDoan = '" + Global.GlobalLop + "'"));
        }
