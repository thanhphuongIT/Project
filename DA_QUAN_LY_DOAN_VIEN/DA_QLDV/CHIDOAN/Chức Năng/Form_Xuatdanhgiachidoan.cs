...
namespace DA_QLDV
{
    public partial class Form_Xuatdanhgiachidoan : Form
    {
        public Form_Xuatdanhgiachidoan()
        {
            InitializeComponent();
        }
        ...
        private void Form_Xuatdanhgiachidoan_Load(object sender, EventArgs e)
        {
            fillGrid(new SqlCommand("select NhanXet.MaNX,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,NhanXet.Uudiem,NhanXet.Khuyetdiem,NhanXet.Xeploai,sinhvien.Picture from Sinhvien INNER JOIN NhanXet  ON NhanXet.MaDV = Sinhvien.MSSV And Sinhvien.CDoan = '" + Global.GlobalLop + "'"));
        }
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                fillGrid(new SqlCommand("select NhanXet.MaNX,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,NhanXet.Uudiem,NhanXet.Khuyetdiem,NhanXet.Xeploai,sinhvien.Picture from Sinhvien INNER JOIN NhanXet  ON NhanXet.MaDV = Sinhvien.MSSV And Sinhvien.CDoan='" + Global.GlobalLop + "' And NhanXet.Xeploai = N'Chưa tốt'"));
            }
            else
            {
                fillGrid(new SqlCommand("select NhanXet.MaNX,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,NhanXet.Uudiem,NhanXet.Khuyetdiem,NhanXet.Xeploai,sinhvien.Picture from Sinhvien INNER JOIN NhanXet  ON NhanXet.MaDV = Sinhvien.MSSV And Sinhvien.CDoan='" + Global.GlobalLop + "' And NhanXet.Xeploai = N'Tốt'"));
            }
        }
