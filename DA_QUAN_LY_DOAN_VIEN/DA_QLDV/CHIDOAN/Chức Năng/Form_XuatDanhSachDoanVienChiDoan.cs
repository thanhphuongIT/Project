...
namespace DA_QLDV
{
    public partial class Form_XuatDanhSachDoanVienChiDoan : Form
    {
        public Form_XuatDanhSachDoanVienChiDoan()
        {
            InitializeComponent();
        }
        ...
        private void Form_XuatDanhSachDoanVienChiDoan_Load(object sender, EventArgs e)
        {
