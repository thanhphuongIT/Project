...
namespace DA_QLDV
{
    public partial class Form_QuanLyKyLuat : Form
    {
        KYLUAT kldv = new KYLUAT();
        public Form_QuanLyKyLuat()
        {
            InitializeComponent();
        }
        //
        ...
        private void Form_QuanLyKyLuat_Load(object sender, EventArgs e)
        {
            fillGrid(new SqlCommand("select KyLuat.MaKL,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,KyLuat.Loaivipham,KyLuat.Hinhthuc,KyLuat.Namhoc,sinhvien.Picture from Sinhvien INNER JOIN KyLuat ON KyLuat.MaDV = Sinhvien.MSSV"));
        }
        //Sửa
        ...
        private void bntLoc_Click(object sender, EventArgs e)
        {
            ...
            string cmd = "(select KyLuat.MaKL,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,KyLuat.Loaivipham,KyLuat.Hinhthuc,KyLuat.Namhoc,sinhvien.Picture FROM Sinhvien INNER JOIN KyLuat ON KyLuat.MaDV = Sinhvien.MSSV) as Bangkyluat";
