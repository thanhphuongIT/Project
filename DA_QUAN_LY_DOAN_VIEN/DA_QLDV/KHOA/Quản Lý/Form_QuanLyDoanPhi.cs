...
namespace DA_QLDV
{
    public partial class Form_QuanLyDoanPhi : Form
    {
        DOANPHI doanphi = new DOANPHI();
        public Form_QuanLyDoanPhi()
        {
            InitializeComponent();
        }
        ...
        private void Form_QuanLyDoanPhi_Load(object sender, EventArgs e)
        {
            fillGrid(new SqlCommand("select Doanphi.MaDP,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,Doanphi.Sotien,Doanphi.Tinhtrang,Doanphi.Namhoc,sinhvien.Picture from Sinhvien INNER JOIN Doanphi ON Doanphi.MaDV = Sinhvien.MSSV"));
        }
        ...
        private void bntLoc_Click(object sender, EventArgs e)
        {
            ...
            string cmd = "(select Doanphi.MaDP,sinhvien.MSSV,sinhvien.Hoten,Sinhvien.Ngaysinh,sinhvien.CDoan,Doanphi.Sotien,Doanphi.Tinhtrang,Doanphi.Namhoc,sinhvien.Picture from Sinhvien INNER JOIN Doanphi ON Doanphi.MaDV = Sinhvien.MSSV) as Bangdoanphi";
