...
namespace DA_QLDV
{
    public partial class Form_XuatDanhSachBiThu : Form
    {
        public Form_XuatDanhSachBiThu()
        {
            InitializeComponent();
        }
        ...
        private void Form_XuatDanhSachBiThu_Load(object sender, EventArgs e)
        {
            fillGrid(new SqlCommand("SELECT * FROM Sinhvien where Chucvu = N'Bí Thư'"));
        }
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            ...
            {
                fillGrid(new SqlCommand("SELECT * FROM Sinhvien WHERE Chucvu = N'Bí Thư' and Gioitinh LIKE N'%" + txtTimkiem.Text + "%'"));
            }
            else if (rbtChidoan.Checked == true)
            {
                fillGrid(new SqlCommand("SELECT * FROM Sinhvien WHERE Chucvu = N'Bí Thư' and Cdoan LIKE N'%" + txtTimkiem.Text + "%'"));
            }
        }
