...
namespace DA_QLDV
{
    public partial class Form_XuatDanhSachDoanVienChuaDongDoanPhi : Form
    {
        public Form_XuatDanhSachDoanVienChuaDongDoanPhi()
        {
            InitializeComponent();
        }
        ...
        private void Form_XuatDanhSachDoanVienChuaDongDoanPhi_Load(object sender, EventArgs e)
        {
            fillGrid(new SqlCommand("select * From(select Doanphi.MaDP, sinhvien.MSSV, sinhvien.Hoten, Sinhvien.Ngaysinh, sinhvien.CDoan, Doanphi.Sotien, Doanphi.Tinhtrang, Doanphi.Namhoc, sinhvien.Picture " +
                            "FROM Sinhvien INNER JOIN Doanphi ON Doanphi.MaDV = Sinhvien.MSSV) as Bangdoanphi where Bangdoanphi.Tinhtrang = N'Chưa nộp'"));
        }
