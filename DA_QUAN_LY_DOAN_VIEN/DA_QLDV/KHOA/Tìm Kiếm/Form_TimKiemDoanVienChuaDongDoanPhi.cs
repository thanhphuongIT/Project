...
namespace DA_QLDV
{
    public partial class Form_TimKiemDoanVienChuaDongDoanPhi : Form
    {
        public Form_TimKiemDoanVienChuaDongDoanPhi()
        {
            InitializeComponent();
        }
        ...
        private void Form_TimKiemDoanVienChuaDongDoanPhi_Load(object sender, EventArgs e)
        {
