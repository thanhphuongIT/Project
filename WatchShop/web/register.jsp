                            ...
                            <div class="login-mail" href="#">
                                ...
                                <fieldset disabled>
                                    <div class="form-group">
                                        <label for="disabledTextInput">Điều khoản tại website FHQ WATCH SHOP</label>
                                        <textarea type="text" id="disabledTextInput" class="form-control" placeholder="">* Mua hàng tại Shop không được đổi trả. &#10;* Bạn hãy chắc địa chỉ bạn gửi là đúng. &#10;* Sau 3 ngày không chuyển khoản, đơn hàng sẽ xóa.&#10;* Phải biết rằng admin cute phô mai que :3</textarea>
                                </fieldset>
