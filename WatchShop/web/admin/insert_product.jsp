        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <form method="post" action="/WatchShop/InsertProductServletx" enctype="multipart/form-data">
           ...
           for (Brand b : brandget.getListBrand()) {
            %>
                        ...
                        <tr><td></td><td>
                                ...
                                <form method="post" action="/WatchShop/UploadProductServlet" enctype="multipart/form-data">
                                    <table width="95%">
