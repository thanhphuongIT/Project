                ...
                <div class="container">
                    <div class="header-left animated wow fadeInLeft" data-wow-delay=".5s">
                        <ul>
                            ...
                            <li><i class="glyphicon glyphicon-envelope" ></i><a href="mailto:contact@fhqwatchshop.com">@fhqwatchshop.com</a></li>
                            <li><i class="glyphicon glyphicon-earphone" ></i>+8496 353 0072</li>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header nav_2">
                            ...
                            <div class="navbar-brand logo-nav-left ">
                                <h1 class="animated wow pulse" data-wow-delay=".5s"><a href="index.jsp">FHQ<span> WATCH SHOP</span></a></h1>
                            </div>
                            ...
                            <ul class="nav navbar-nav">
                                    ...
                                    <ul class="dropdown-menu multi">
                                        ...
                                        <div class="row-top">
                                            <div class="col-sm-6 row1">
                                                <a href="manwatch.jsp"><img src="images/me.jpg" alt="" class="img-responsive"></a>
                                            </div>
                                            <div class=" col-sm-6 row2">
                                                <a href="womanwatch.jsp"><img src="images/me1.jpg" alt="" class="img-responsive"></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu multi">
                                        ...
                                        <div class="row-top">
                                            <div class="col-sm-6 row1">
                                                <a href="productbrand.jsp?brand=1"><img src="images/Casio.jpg" alt="" class="img-responsive"></a>
                                            </div>
                                            <div class=" col-sm-6 row2">
                                                <a href="productbrand.jsp?brand=4"><img src="images/Orient.jpg" alt="" class="img-responsive"></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
